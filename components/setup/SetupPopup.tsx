...
function SetupIcons({ currentStage }: SetupIconsProps) {
    ...
    const stageNames = ['Your Details', 'Business Details', 'Plans & Pricing', 'Network'];
            ...
            <DialogContent className='max-w-screen-lg'>
                <DialogHeader>
                    <div className='flex flex-col gap-8'>
                        ...
                        {stage === 1 && <YourDetailsForm onSubmit={handleYourDetailsSubmit} initialData={formData.details} />}
                        {stage === 2 && <BusinessDetailsForm onSubmit={handleBusinessDetailsSubmit} onBack={goBack} initialData={formData.businessDetails} />}
                        {stage === 3 && <PlansForm onSubmit={handlePlansDetailsSubmit} onBack={goBack} initialData={formData.planDetails} />}
