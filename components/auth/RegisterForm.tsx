        ...
        <div className='flex flex-col gap-8 h-full'>
            <div className='flex flex-col gap-4'>
                ...
                <p className="text-sm">
                    ...
                    <span onClick={onSwitchToLogin} className='text-primary cursor-pointer hover:underline pl-1'>
                    Login
                    </span>
                </p>
            </div>
            {isComplete ? (
                <div className="flex flex-row bg-green-800 p-2 gap-2 rounded-xl">
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <p className="text-base text-card-foreground">Please check your email to verify your account.</p>
                    </div>
                </div>
            ) : (
                <Form {...form}>
