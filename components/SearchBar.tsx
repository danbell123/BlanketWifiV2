...
const SearchBar = () => {
  ...
  return (
    <div
      className={`bg-background ${isOpen ? "w-full" : "w-2/3"} flex justify-between items-center relative transition-all`}
    >
      <Command>
        <CommandInput
            ...
            >
              <CommandList>
                ...
                <CommandGroup heading="Actions">
                  <CommandItem>
                    <span className="material-icons pr-2">add</span>New Segment
                  </CommandItem>
                  <CommandItem>
                    <span className="material-icons pr-2">send</span>Send Pulse
                  </CommandItem>
                  <CommandItem>
                    <span className="material-icons pr-2">router</span>Edit
                    Portal
                  </CommandItem>
                </CommandGroup>
                <CommandSeparator />
